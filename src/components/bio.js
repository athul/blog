  ...
  return (
    ...
    >
      ...
      <p>
        ...
        <span >
          <a href="https://github.com/Athul-CA" style={{color:`white`}}>
            <img
              alt="Github"
          ...
          {/* </span>
        <span> */}
          <a href="https://twitter.com/athulcajay" style={{color:`white`}}>
            <img
              alt="Twitter"
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;
          <a href="https://instagram.com/athul_c_ajay" style={{color:`white`}}>
            <img
              alt="Instagram"
