...
The command part and connection is a simple `goroutine` dialing the websocket and connecting to it, but the difference here is that it connects from a Terminal🤪.

## Phase 3 - Making it Better
<Callout emoji="🌐">
    You can find the source code on <a href="https://github.com/athul/termchat">GitHub</a>
</Callout><br/>
This is not the perfect implementation but it works, so sharing this 😅. I felt so proud that I hacked this up in the quarantine and learned a bit more of Go and websockets with this. Who knows, makng this better may help someone in some way. 
Some ways it could be used is,<br/>

- Secret message passing in Local network(Like in Programming labs in college😂)
...
> The chat in video is me talking to myself in 3 other aliases 🤪

Here is another nerdy websoket Meme 👇
